...
trait CanGenerateThumbnail
{
    ...
    public function getGeneratedThumbnailImage(TemporaryUploadedFile $file): Image
    {
        ...
        return $manager->read($file->getRealPath())->resize($this->getThumbnailImageWidth(), $this->getThumbnailImageHeight(), function (Constraint $constraint) {
